...
export default function ExitPolls() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-6xl mx-auto px-4 py-6 space-y-6">
        {/* Page title */}
        <div className="mb-6">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-2">Exit Poll Tracker</h1>
          <p className="text-gray-600">
            Predictions from major polling agencies based on voter surveys conducted on polling day.
          </p>
        </div>
